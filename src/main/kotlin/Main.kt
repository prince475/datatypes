...
fun main(args: Array<String>) {
    ...
    // the 'when' use case is like switch statement in other langauges.
    ...
    // to indicate that a variable can be bull then use a question mark operator ? after the data type, with this done then you can assign a null to it
    ...
    // if dogFoodTreat is not null just decrenent and use it
    // ?: the elvis operator
    ...
    // the initalization code is between the curly braces {}. 'it' refers to the array index starting with 0
    ...
    // repeat loops are also availble
    var bubbles = 0
    while (bubbles < 50) {
        bubbles++
    }
